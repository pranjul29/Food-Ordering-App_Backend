...
public final class RestaurantTransformer {

  public static RestaurantListResponse toRestuarantListResponse(
  ...
  public static RestaurantDetailsResponse toResponseEntityWithCategoryItems(
      RestaurantEntity restaurantEntity) {
    RestaurantDetailsResponse restaurantDetailsResponse = new RestaurantDetailsResponse();
    RestaurantDetailsResponseAddress address = setDetailsAddress(restaurantEntity);
    restaurantDetailsResponse.address(address);
    List<CategoryList> categoryLists = new ArrayList();
    for (RestaurantCategoryEntity restaurantCategoryEntity :
        restaurantEntity.getRestaurantCategories()) {
  ...
  public static RestaurantDetailsResponseAddress setDetailsAddress(
      RestaurantEntity restaurantEntity) {
