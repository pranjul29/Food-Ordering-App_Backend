...
public class CustomerControllerTest {
  ...
  // This test case passes when you have handled the exception of trying to login with a contact
  // number that is not
  // registered yet.
  @Test
  public void shouldNotLoginIfNoDataPresentForGivenMobileNo() throws Exception {
    when(mockCustomerService.authenticate("123", "CorrectPassword"))
        .thenThrow(
            new AuthenticationFailedException("ATH-001", "This contact number does not exist"));
    mockMvc
        .perform(
            post("/customer/login")
                .contentType(MediaType.APPLICATION_JSON_UTF8_VALUE)
  ...
  // This test case passes when you have handled the exception of trying to login with incorrect
  // password.
  @Test
  ...
  // This test case passes when you have handled the exception of trying to logout when you have
  // already logged out.
  @Test
  ...
  // This test case passes when you have handled the exception of trying to update user details but
  // the first name
  // field is empty.
  @Test
  ...
  // This test case passes when you have handled the exception of trying to update customer details
  // when the customer
  // is not logged in.
  @Test
  ...
  public void shouldUpdateCustomerPassword() throws Exception {
    ...
    verify(mockCustomerService, times(1))
        .updateCustomerPassword("oldPwd", "newPwd", customerEntity);
  }

  // This test case passes when you have handled the exception of trying to update your password but
  // your old password
  // field is empty.
  @Test
  ...
  // This test case passes when you have handled the exception of trying to update your password
  // when your new password
  // field is empty
  @Test
