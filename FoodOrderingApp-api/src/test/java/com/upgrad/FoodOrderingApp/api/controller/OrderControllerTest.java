...
public class OrderControllerTest {
  ...
  // This test case passes when you have handled the exception of trying to save an order while your
  // session is
  // already expired.
  @Test
  ...
  // This test case passes when you have handled the exception of trying to save an order while the
  // payment id you gave
  ...
  public void shouldNotSaveOrderIfPaymentMethodDoesNotExists() throws Exception {
    ...
    when(mockPaymentService.getPaymentByUUID(saveOrderRequest.getPaymentId().toString()))
        .thenThrow(
            new PaymentMethodNotFoundException("PNF-002", "No payment method found by this id"));
  ...
  // This test case passes when you have handled the exception of trying to fetch placed orders if
  ...
  // This test case passes when you have handled the exception of trying to fetch coupon details if
  // you are not logged in.
  @Test
  ...
  // This test case passes when you have handled the exception of trying to fetch any coupon but
  // your coupon name
  // field is empty.
  @Test
  ...
  // This test case passes when you have handled the exception of trying to fetch coupon details
  // while there are no
  ...
  private OrderEntity getOrderEntity(final CustomerEntity customerEntity) {
    ...
    final AddressEntity addressEntity =
        new AddressEntity(addressId, "a/b/c", "someLocality", "someCity", "100000", stateEntity);
