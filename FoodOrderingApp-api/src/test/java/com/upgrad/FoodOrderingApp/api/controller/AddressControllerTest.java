...
public class AddressControllerTest {
  ...
  @MockBean private AddressService mockAddressService;
  ...
  public void shouldSaveAddress() throws Exception {
    ...
    mockMvc
        .perform(
            post("/address?content=my_address")
                .contentType(MediaType.APPLICATION_JSON_UTF8_VALUE)
                .header("authorization", "Bearer database_accesstoken2")
                .content(
                    "{\"flat_building_name\":\"xyz\", \"locality\":\"abc\", \"city\":\"pqr\", \"pincode\":\"\", \"state_uuid\":\"testUUID\"}"))
  ...
  //
  //    //This test case passes when you have handled the exception of trying to save an address
  // with non existing access-token.
  @Test
  ...
  //
  //    //This test case passes when you have handled the exception of trying to save an address
  // with incorrect state uuid.
  @Test
  public void shouldNotSaveAddressWithIncorrectStateId() throws Exception {
    when(mockCustomerService.getCustomer("database_accesstoken2")).thenReturn(new CustomerEntity());
    when(mockAddressService.getStateByUUID("testUUID"))
        .thenThrow(new AddressNotFoundException("ANF-002", "No state by this state id"));
    ...
    mockMvc
        .perform(
            post("/address?content=my_address")
                ...
                .header("authorization", "Bearer database_accesstoken2")
                .content(
                    "{\"flat_building_name\":\"xyz\", \"locality\":\"abc\", \"city\":\"pqr\", \"pincode\":\"100000\", \"state_uuid\":\"testUUID\"}"))
  ...
  //
  //    //This test case passes when you have handled the exception of trying to save an address
  // with empty address field.
  @Test
  public void shouldNotSaveAddressWithEmptyAddressField() throws Exception {
    when(mockCustomerService.getCustomer("database_accesstoken2")).thenReturn(new CustomerEntity());
    when(mockAddressService.getStateByUUID("testUUID")).thenReturn(new StateEntity());
    when(mockAddressService.saveAddress(any(), any()))
        .thenThrow(new SaveAddressException("SAR-001", "No field can be empty"));
    ...
    mockMvc
        .perform(
            post("/address?content=my_address")
                ...
                .header("authorization", "Bearer database_accesstoken2")
                .content(
                    "{\"flat_building_name\":\"xyz\", \"locality\":\"abc\", \"city\":\"\", \"pincode\":\"123456\", \"state_uuid\":\"testUUID\"}"))
  ...
  //
  //    //This test case passes when you have handled the exception of trying to save an address
  // with incorrect pincode.
  @Test
  public void shouldNotSaveAddressWithEmptyWrongPinCode() throws Exception {
    when(mockCustomerService.getCustomer("database_accesstoken2")).thenReturn(new CustomerEntity());
    when(mockAddressService.getStateByUUID("testUUID")).thenReturn(new StateEntity());
    when(mockAddressService.saveAddress(any(), any()))
        .thenThrow(new SaveAddressException("SAR-002", "Invalid pincode"));
  ...
  public void shouldDeleteAddress() throws Exception {
    ...
    final AddressEntity addressEntity = new AddressEntity();
    when(mockAddressService.getAddressByUUID(
            "82849cd5-106e-4b34-b9bf-94954c6ff527", customerEntity))
    ...
    mockMvc
        .perform(
            delete("/address/82849cd5-106e-4b34-b9bf-94954c6ff527")
                .contentType(MediaType.APPLICATION_JSON_UTF8_VALUE)
                .header("authorization", "Bearer database_accesstoken2")
                .content(
                    "{\"flat_building_name\":\"xyz\", \"locality\":\"abc\", \"city\":\"pqr\", \"pincode\":\"100000\", \"state_uuid\":\"c860e78a-a29b-11e8-9a3a-720006ceb890\"}"))
  ...
  // This test case passes when you have handled the exception of trying to delete an address with
  ...
  // This test case passes when you have handled the exception of trying to delete an address with a
  // signed out user.
  @Test
  ...
  // This test case passes when you have handled the exception of trying to delete an address of a
  // different customer
  ...
  public void shouldGetAllAddresses() throws Exception {
    ...
    when(mockAddressService.getAllAddress(customerEntity))
    ...
    final AddressListResponse addressLists =
        new ObjectMapper().readValue(response, AddressListResponse.class);
  ...
  //
  //    //This test case passes when you have handled the exception of trying to fetch addresses for
  // any customer with non existing access-token.
  @Test
  ...
  public void shouldGetAllStates() throws Exception {
    ...
    final StatesListResponse statesLists =
        new ObjectMapper().readValue(response, StatesListResponse.class);
  ...
  // This test case passes when you are not able to retrive any states if there are no states saved
  // in the database.
  @Test
