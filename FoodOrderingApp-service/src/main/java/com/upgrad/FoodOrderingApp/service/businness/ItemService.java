...
public class ItemService {
  ...
  @Autowired UtilityProvider utilityProvider;
    ...
    ordersEntities.forEach(
        ordersEntity -> {
          ...
          orderItemEntities.forEach(
              orderItemEntity -> { // Looping in to get each tem from the OrderItemEntity.
