...
@NamedQueries({
  @NamedQuery(
      name = "CategoryEntity.byAll",
      query = "SELECT g FROM CategoryEntity g order by g.categoryName"),
  @NamedQuery(
      name = "CategoryEntity.byUUid",
      query = "SELECT g FROM CategoryEntity g where g.uuid=:uuid"),
  @NamedQuery(
      name = "CategoryEntity.getAllCategoriesOrderedByName",
      query = "SELECT g FROM CategoryEntity g order by g.categoryName")
})
